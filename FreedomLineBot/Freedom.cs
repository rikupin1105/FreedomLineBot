...
namespace FreedomLineBot
{
    ...
    {
        public static LineMessagingClient lineMessagingClient { get; set; }
        ...
        public static List<string> Admin_Users = Admin_Users = Environment.GetEnvironmentVariable("ADMIN_USER").Split(',').ToList();
