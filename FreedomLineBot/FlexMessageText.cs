  ...
  ""contents"": {
    ...
    ""body"": {
      ...
      ""contents"": [
        ...
        {
              ""type"": ""text"",
              ""text"": ""BOTの反応は数秒から数十秒遅れることがあります。何度も押す必要はありませんが、数分経っても返答がない場合は再度押していただくか、管理メンバーに連絡してください。実施期間終了の前日、または前々日に意思表示をされていないメンバーさん宛にメンションをつけて、管理メンバーがGTにてご連絡をします。実施期間終了後、継続を希望しないメンバーさんを、管理メンバーが退会大会に出場させます。ブロック非表示削除等は、各自自由に判断してください。"",
              ""flex"": 5,
              ""wrap"": true,
              ""size"": ""sm"",
              ""color"": ""#666666""
